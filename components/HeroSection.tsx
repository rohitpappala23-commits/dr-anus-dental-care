...
export default function HeroSection({ onBookClick }: { onBookClick?: () => void }) {
  ...
  return (
    <section className="relative w-full min-h-[90vh] flex items-center pt-28 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
        ...
        <div className="flex-1 space-y-8">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 leading-tight drop-shadow-sm">
            Advanced, Gentle <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button
              ...
              className="px-8 py-4 bg-[#970747] hover:bg-[#7a0539] text-white rounded-full font-semibold transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
            >
            ...
            <a
              ...
              className="px-8 py-4 bg-white hover:bg-slate-50 text-[#970747] border-2 border-[#970747]/20 rounded-full font-semibold transition-all flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
